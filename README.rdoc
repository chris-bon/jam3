...
* Musician Seeker (for gigs, parties, live events, etc.)
  ...
  Useful for finding a particular kind of musician at the last minute
      or for finding a musician to become a part of you're band.

  For example: you might be playing at a Jazz club,
               but you're bassist is unable to play.
               With the Musician Seeker, you can easily find another bassist.
