...
jQuery(function ($) {
  var COMPONENT_SELECTOR = '#thredded--container abbr.timeago';
...
(function ($) {
  ...
  var NOTIFY_ON_MENTION_SELECTOR = ':checkbox[name="user_preferences_form[notify_on_mention]"]';
  var MESSAGEBOARD_NOTIFY_ON_MENTION_SELECTOR = '[name="user_preferences_form[messageboard_notify_on_mention]"]';

  var UserPreferencesForm = (function () {
    function UserPreferencesForm(form) {
      var _this = this;
      ...
      this.$messageboardNotifyOnMention.on('change', function () {
        _this.rememberMessageboardNotifyOnMentionChecked();
      });
      this.rememberMessageboardNotifyOnMentionChecked();

      this.$notifyOnMention.on('change', function () {
        _this.updateMessageboardNotifyOnMention();
      });
      this.updateMessageboardNotifyOnMention();
    }

    _createClass(UserPreferencesForm, [{
      key: 'rememberMessageboardNotifyOnMentionChecked',
      value: function rememberMessageboardNotifyOnMentionChecked() {
        this.messageboardNotifyOnMentionCheckedWas = this.$messageboardNotifyOnMention.filter(':checkbox').prop('checked');
      }
    }, {
      key: 'updateMessageboardNotifyOnMention',
      value: function updateMessageboardNotifyOnMention() {
        var enabled = this.$notifyOnMention.prop('checked');
        this.$messageboardNotifyOnMention.prop('disabled', !enabled).filter(':checkbox').prop('checked', enabled ? this.messageboardNotifyOnMentionCheckedWas : false);
      }
    }]);
